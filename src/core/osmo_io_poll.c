...
static inline void iofd_poll_ofd_cb_recvmsg_sendmsg(struct osmo_fd *ofd, unsigned int what)
{
	...
	if (what & OSMO_FD_READ) {
		...
		case OSMO_IO_FD_MODE_RECVFROM_SENDTO:
			iofd->io_ops.recvmsg_cb(iofd, rc, msg, &hdr.osa);
			break;
...
void iofd_poll_close(struct osmo_io_fd *iofd)
{
...
struct iofd_backend_ops iofd_poll_ops = {
